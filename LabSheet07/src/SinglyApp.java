...
public class SinglyApp {
	...
	public static void testGet() {
		...
		System.out.println("Get element index " + i + " = " + (list1.get(i) == null ? "No data" : list1.get(i)));
		System.out.println("Get element index " + j + " = " + (list1.get(j) == null ? "No data" : list1.get(j)));
	}
	...
	public static void testContains() {
		...
		System.out.println(list1.contains(find1) ? (find1 + " found!!") : "not found...");
		System.out.println(list1.contains(find2) ? (find2 + " found!!") : "not found...");
	}
	...
	public static void testAddAll() {
				...
				list1.addAll(list2);
				System.out.println("Merge reult => " + list1.displayList());
				System.out.println("");
